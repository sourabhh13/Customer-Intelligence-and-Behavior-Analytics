...
The raw dataset was loaded and cleaned using Python.

Missing values were handled and new analytical features such as age groups and purchase frequency were created.

The cleaned dataset was loaded into a SQL database.

SQL queries were written to analyze revenue, customer segments, product performance, discounts, and subscriptions.

Power BI was connected to the database to create an interactive dashboard.

A business report was prepared summarizing insights and recommendations.
